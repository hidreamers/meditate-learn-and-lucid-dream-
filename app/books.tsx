// --- Styles (must be after all component/function definitions) ---
            ...
            <View style={modalStyles.overlay}>
                <View style={modalStyles.playerCard}>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: '100%', marginTop: 8 }}>
                        <Text style={{ fontSize: 14, color: '#3a1c71' }}>{formatTime(position)}</Text>
                        <Text style={{ fontSize: 14, color: '#3a1c71' }}>{formatTime(duration)}</Text>
                    </View>
  ...
  const chapters = [
    {
      title: 'Chapter One: The Scientist',
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/jkotslr0ddv8oeaancv4a/Chapter-One-The-Scientist.mp3?rlkey=bp6tvz3k2562b8urn0m09znbd',
    },
    {
      title: 'Chapter Two: The Soldier',
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/m1e9cay5z1t497tppep5t/Chapter-Two-The-Soldier.mp3?rlkey=6cg36oa70kx489ei1w4hzsf7s',
    },
    {
      title: 'Chapter Three: The Hacker',
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/1rdkp5pbigp1kmnr8ytug/Chapter-Three-The-Hacker.mp3?rlkey=s80xy512cryrpgx4d6cx2a0cm',
    },
    {
      title: 'Chapter Four: Good and Evil',
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/o17cr449g1zb5phj1qk3x/Chapter-Four-Good-and-Evil.mp3?rlkey=tsbwtzp7ds7xmyyuxbx37h38x',
    },
    {
      title: 'Chapter Five: The Convergence',
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/8rbcomxha462ggcn09q08/Chapter-Five-The-Convergence.mp3?rlkey=js07z19etybgmaz4vhl7l794t',
    },
    {
      title: 'Chapter Six: A New World',
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/3s1a4botx26a5drzsabvi/Chapter-Six-A-New-World.mp3?rlkey=xs25jw78th6tk722gj2bauued',
    },
    {
      title: 'Chapter Seven: The Return Back to Earth',
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/gfr35lul4mv6mmlr3xdu2/Chapter-Seven-The-Return-Back-to-Earth.mp3?rlkey=gtsdqit1lrgkyof8c1al5sgv8',
    },
    {
      title: 'Chapter Eight: The Rebuilding of Earth',
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/9alq4cm7h93uhz6965pty/Chapter-8-The-Rebuilding-of-Earth.mp3?rlkey=s0lsrp5lpu1dv20i8m1muhv9n',
    },
  ];
  ...
  const chapters = [
    {
      ...
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/g387tqmo4gri16kkigrii/Chapter-1_The-Beginning.mp3?rlkey=93cz1f8drybimz49gyppklgpq',
      image: 'https://www.hidreamers.com/wp-content/uploads/2024/05/t03awb8c.png',
    },
    {
      title: 'Chapter 2: Awareness Through Dedication',
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/10ukoyq9uc94kgq5nmnzm/Chapter-2_Awareness-Through-Dedication.mp3?rlkey=wqcp1dlmuelewkqizb8amm5fj',
    ...
    },
    {
      ...
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/91p7drtavwhil05wk40ia/Chapter-3_Non-Physical-Weather_-Thoughts-and-Emotions.mp3?rlkey=qtfobb7j172vuylrktv1aumy4',
      image: 'https://www.hidreamers.com/wp-content/uploads/2024/05/gji3fuuw.png',
    },
    {
      title: 'Chapter 4: Alchemy Part 1',
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/v4ppq2201ku7tdpmejg51/Chapter-4_Alchemy_Part-1.mp3?rlkey=k4iuacodc5n9xcc7bbp23yd1q',
      image:
        'https://www.hidreamers.com/wp-content/uploads/2024/05/DALL·E-2024-01-24-17.36.10-In-this-surreal-and-vivid-scene-Seth-finds-himself-1000-feet-in-the-air-holding-someones-hand-while-encountering-an-old-man-blending-with-the-elect-1.png',
    },
    {
      title: 'Chapter 4: Alchemy Part 2',
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/se2xkqf4eebuioab1j77a/Chapter-4_Alchemy_Part-2.mp3?rlkey=4pwi8hy2xy1z6a8rg5ov79ej8',
    ...
    },
    {
      ...
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/ov5k5wjb6mrujderp81hc/Chapter-5_Creating-a-Constructive-Attitude-and-Building-Will-Power-1.mp3?rlkey=glj0o85nrykj3v7s50yfiw9qs',
    ...
    },
    {
      ...
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/djm0wmhaamtuua1156yn0/Chapter-5_Creating-a-Constructive-Attitude-and-Building-Will-Power.mp3?rlkey=258qbdg9juosv2ggdwv1juz5h',
      image: 'https://www.hidreamers.com/wp-content/uploads/2024/05/6ch8z3zp.png',
    },
    {
      title: 'Chapter 6: Lucid Dreaming',
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/m49vrc8xw5vxa1cii7vu2/Chapter-6_Lucid-Dreaming.mp3?rlkey=fxvx24c5gmscgnnu0w2q1fmd1',
    ...
    },
    {
      ...
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/b35h1m89on9rlowjz47mb/Chapter-7_Wake-Induced-Lucid-Dreaming.mp3?rlkey=v5dwtcvwlfanecn72c5yfk086',
      image:
        'https://www.hidreamers.com/wp-content/uploads/2024/05/DALL·E-2024-01-25-14.38.07-The-image-captures-the-moment-of-Seths-incredible-dream-journey-to-space.-Seth-lies-in-bed-eyes-closed-determined-to-experience-a-dream.-He-realize.png',
    },
    {
      title: 'Chapter 8: Conversion Through Mnemonic Induced Manifestation',
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/tbxokvh1zeeqb7ksjxny8/Chapter-8-_-Conversion-Through-Mnemonic-Induced-Manifestation.mp3?rlkey=8ltv7c7mp44nqtm3tjxyxtvzd',
      image:
        'https://www.hidreamers.com/wp-content/uploads/2024/05/DALL·E-2024-01-24-17.13.42-The-image-vividly-captures-a-mystical-and-transformative-moment.-Light-beings-swarm-around-the-viewer-radiating-light-with-every-movement.-A-flash-of-1.png',
    },
    {
      title: 'Chapter 9: Wake Induced Manifestation',
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/3awx49tngg9z1pnpbunyi/Chapter-9_Wake-Induced-Manifestation.mp3?rlkey=h3msd6p5hc668znuy9iqzv54p',
      image:
        'https://www.hidreamers.com/wp-content/uploads/2024/05/DALL·E-2024-01-25-17.30.51-In-my-dream-I-missed-my-dad-a-lot-but-the-bright-moonlight-made-me-feel-loved-and-special.-I-went-to-the-bathroom-and-looked-in-the-mirror.-It-felt-.png',
    },
    {
      title: 'Chapter 10: Planetary Expressions',
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/4fxo96dbmqhceeyxgctf8/Chapter-10_-Planetary-Expressions.mp3?rlkey=hu9yedlxy570exvzgsle3yw8a',
      image: 'https://www.hidreamers.com/wp-content/uploads/2024/05/8nvtzkof.png',
    },
    {
      title: 'Chapter 11: Healing',
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/niaehkxqx4utexaq7bfy4/Chapter-11_-Healing.mp3?rlkey=1rkne9jysb4gcqwfa4532nlco',
      image: 'https://www.hidreamers.com/wp-content/uploads/2024/05/6sosqwzh.png',
    },
    {
      title: 'Chapter 12: Conclusion',
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/wk4931ju6ouo11cx9ay2g/Chapter-12_-Conclusion.mp3?rlkey=jf61wvo3t9p9ph0pypdtizp53',
  ...
  const chapters = [
    {
      ...
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/dyhbsu5o9tluvs2o96jfc/ch1.mp3?rlkey=vvs4uwkz16vxyengzjnbjboyt',
      image: 'https://www.hidreamers.com/wp-content/uploads/2024/05/page11.png',
    },
    {
      title: 'Chapter 2: The Diary',
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/okfl0tgvhh6uiwlmx4amk/Ch-2-The-Diary.mp3?rlkey=y4ii46shryvfn0c2ukpfid5og',
      image: 'https://www.hidreamers.com/wp-content/uploads/2024/05/xgvfbxmd.png',
    },
    {
      title: 'Chapter 3: The Awakening',
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/tu1n24636wp9wxfsvprta/ch3-1.mp3?rlkey=cqhelf8dku9ttrilj5fwyrq80',
      image:
        'https://www.hidreamers.com/wp-content/uploads/2024/05/DALL·E-2024-01-24-17.19.37-The-image-portrays-two-angels-sitting-on-a-page-curl-symbolizing-a-transition-between-two-realms.-On-one-side-of-the-page-curl-theres-a-realm-fille.png',
    },
    {
      title: 'Chapter 4: The Confusion',
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/awje1jkparw25mwgpplrr/Ch-4-The-confusion.mp3?rlkey=qnxb5o4my6796i9brgmfm6y7z',
      image:
        'https://www.hidreamers.com/wp-content/uploads/2024/05/DALL·E-2024-01-24-17.00.06-The-image-captures-a-transformative-moment-where-the-storm-begins-to-dissipate-around-Seth-giving-way-to-a-serene-and-spiritual-scene.-Six-angelic-be.png',
    },
    {
      title: 'Chapter 5: The Uniting',
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/tnk6085asmdrexolz99aj/Ch-5-The-Uniting.mp3?rlkey=ul5zsitqxdm07rmql1305zp0e',
      image: 'https://www.hidreamers.com/wp-content/uploads/2024/05/8xzfx1k8.png',
    },
    {
      title: 'Chapter 6: The Transformation',
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/01nvyteyeeez21qs6zl7j/ch6-1-1.mp3?rlkey=2f7hzejqs4ya4u1rd5gb6vcde',
  ...
  const chapters = [
    {
      ...
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/ucm4bo2vyiwgkbew5x5mr/Chapter-One-The-Beginning.mp3?rlkey=fj6l9g9rqjjel4oexr7pzyi74',
    },
    {
      title: 'Chapter Two: Becoming a Teenager',
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/iln5bip90wbn9nisiqu2s/Chapter-Two-Becoming-a-Teenager.mp3?rlkey=9lrepawcbkiu4gadrc7qx4uh5',
    },
    {
      title: 'Chapter Three: The Dreamer Awakens',
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/ezomta4pt21k67f35nuh7/Chapter-Three-The-Dreamer-Awakens.mp3?rlkey=yqxqbkmffr52cclx435lwaw1p',
    },
    {
      title: 'Chapter Four: Becoming an Adult',
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/3rj4j59ewpovag82fw2rn/Chapter-Four-Becoming-an-Adult.mp3?rlkey=fr7tmau8pc3u5c0h8zybhii9s',
    },
    {
      title: 'Chapter Five: Becoming a Shaman',
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/7ybk6ewgh8vq15wpyg323/Chapter-Five-Becoming-a-Shaman.mp3?rlkey=ezjcntaqyxtifnr1chzltrqhd',
    },
    {
      title: 'Chapter Six: Fatherhood',
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/05prvrrsmhalgkms6jtt5/Chapter-six-Fatherhood.mp3?rlkey=hmmk2ez9ot9aashk7apz1tgrv',
    },
    {
      title: 'Chapter Seven: Full Circle',
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/ik7ny8ehma0rg9tx28w97/Chapter-seven-full-circle.mp3?rlkey=2j3pvg8jswtt8b3203ls4z2k0',
    },
    {
      title: 'Chapter Eight: Conclusion',
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/vjv664yzxssupbn2iibv6/Chapter-eight-Conclusion.mp3?rlkey=umojzxvdlnkjiqrfksfgyvki2',
    },
    {
      title: 'Chapter Nine: Lucid Dreaming Introduction',
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/u4z62gaioqawq41daafd0/Chapter-Nine-Lucid-Dreaming-Introduction.mp3?rlkey=6622ga29czpfdo7uephqbzwi0',
    },
    {
      title: 'Chapter Ten: MILD - Mnemonic Induced Lucid Dreaming',
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/d448nwdwmt7j17b48h6eb/Chapter-Ten-MILD-Mnemonic-Induced-Lucid-Dreaming.mp3?rlkey=qvcopp2c5dn4lkiaw21csiaxy',
    },
    {
      title: 'Chapter Eleven: Wake Induced Lucid Dreaming and Dream Yoga',
      audio:
        'https://dl.dropboxusercontent.com/scl/fi/86qvfmsd83072uh5bplnc/Chapter-eleven-wake-induced-lucid-dreaming-and-dream-yoga.mp3?rlkey=3g8hu5d8ou6htlug292lninor',
    },
  ];
  return <AudioDropdown chapters={chapters} />;
}
...
function BooksScreen() {
  ...
  return (
    <LinearGradient colors={['#3a1c71', '#b993d6', '#fff']} style={styles.gradientBackground}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Books by Jerimiah Molfese</Text>
        <Text style={styles.headerSubtitle}>Recommended reading and resources for lucid dreaming</Text>
      </View>
          ...
          return (
            <View key={book.id} style={styles.bookCard}>
              <Image
                ...
                style={[styles.bookCover, locked && { opacity: 0.5 }]}
                resizeMode="contain"
              />
              ...
              {locked ? (
                <TouchableOpacity
                  ...
                  onPress={() => Linking.openURL('https://your-upgrade-link-or-navigate-to-upgrade')}
                  activeOpacity={0.85}
                >
                  <Text style={{ color: '#fff', fontWeight: 'bold' }}>Unlock with Premium</Text>
                </TouchableOpacity>
              ) : (
                book.link && (
                  <TouchableOpacity
              ...
              {/* Audio dropdowns, lock if not premium */}
              {book.title === 'Convergence and the Love Code' &&
                (!locked ? <ConvergenceAudioDropdown /> : <LockedBanner />)}
              {book.title ===
                'Manifestation Through Spiritual Power: Unlock the secrets of Lucid Dreaming and Alchemy' &&
                (!locked ? <ManifestationAudioDropdown /> : <LockedBanner />)}
              {book.title === 'The Seventh Angel' &&
                (!locked ? <SeventhAngelAudioDropdown /> : <LockedBanner />)}
              {book.title?.startsWith('A Dreamer’s Odyssey') &&
                (!locked ? <OdysseyAudioDropdown /> : <LockedBanner />)}
            </View>
          );
        })}
        {!isPremium && (
          ...
          >
            <Text style={{ color: '#fff', fontWeight: 'bold', fontSize: 16 }}>
              Unlock All Books & Audio with Premium
            </Text>
          </TouchableOpacity>
        )}
      </ScrollView>
...
function LockedBanner() {
  return (
    <View style={{ marginTop: 10, marginBottom: 10, alignItems: 'center' }}>
      <Text style={{ color: '#d76d77', fontWeight: 'bold', fontSize: 15 }}>Premium</Text>
      <Text style={{ color: '#555', fontSize: 13, marginTop: 2 }}>
        Unlock with Premium to access this audio book
      </Text>
    </View>
  );
}
